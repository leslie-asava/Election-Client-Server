...
gcc concurrent_threads_tcp_election_server.c -o concurrent_threads_tcp_election_server -lpthread
    ...
    while (1)
    {
        ...
        *connfd = accept(sockfd,
        ...
        else
        {
            ...
            pthread_create(&thread, 0, func, (void *)connfd);
            pthread_detach(thread);
            printf("\n[+] Started thread for client...\n");
        }
    }
